package de.fu_berlin.cdv.chasingpictures.utilities
 ...
 */
    ...
    public fun showError(context: Context, formatString: String, vararg args: Any) {
     ...
     * @param args    Arguments to be formatted into the string
     */
    public fun showError(context: Context, StringRes resID: Int, vararg args: Any) {
     ...
     * @param args    Arguments to be formatted into the string
     */
    public fun showToast(context: Context, StringRes resID: Int, vararg args: Any) {
     ...
     */
    public fun removeURLUnderlines(text: Spannable): Spannable {
     ...
     */
    public fun getTextAsHtml(text: String): Spannable {
     ...
     */
    public fun getTextAsHtml(text: String, underlines: Boolean): Spannable {
     ...
     */
    public fun linkifyTextView(textView: TextView) {
     ...
     * @param underlines Whether or not the links should be underlined
     */
    public fun setLinkifiedText(textView: TextView, text: String, underlines: Boolean) {
     ...
     * @param text     The text to parse
     */
    public fun setLinkifiedText(textView: TextView, text: String) {
     ...
     */
    public fun setLinkifiedText(context: Context, textView: TextView, StringRes textResId: Int) {
     ...
     */
    public fun setLinkifiedText(context: Context, textView: TextView, StringRes textResId: Int, underlines: Boolean) {
