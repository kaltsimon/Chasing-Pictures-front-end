...
if __name__ == '__main__':
    ...
    parser.add_argument('gpx', help='A GPX file containing routing information', type=str)
    parser.add_argument('-s', '--host', type=str, default="127.0.0.1", help='Host')
    parser.add_argument('-p', '--port', type=int, default=5554, help='Port')
    parser.add_argument('-x', '--speed', type=int, default=20, help='Speed in km/h')
    parser.add_argument('-t', '--step', type=int, default=10, help='Step distance in meters')
